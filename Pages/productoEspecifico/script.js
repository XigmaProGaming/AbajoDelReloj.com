let productsCard = [
    ...
    },
    {
        ...
        brand: "Apple",
        price: 33999,
        img: [`https://http2.mlstatic.com/D_NQ_NP_2X_888876-MLA52132166567_102022-F.webp`, `https://http2.mlstatic.com/D_NQ_NP_2X_704642-MLA52132199134_102022-F.webp` , "url3"],
        rating: 5.0,
...
//${productsCard[0].description}
// Crear un string donde se agreguen la primera imagen y un for para el resto de las imagenes del carrusel, y luego agregar con innerHTML a la ubicacion especifica 
// Tener listo en el HTML toda la estructura, solo sustituir informacion con plantillas literarias
// Boton agregar al carrito agrega al local storage un string con "id,cantidad"
...
<div class="row">
      ...
      <div class="row  gy-2">
        <div class="col-2 d-none d-md-block" id="previewPics">
          ...
          <a data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1" >
            <img src="${productsCard[0].img[0]}" class="d-block w-100 img-thumbnail" alt="...">
          </a>
          <a data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2">
            <img src="${productsCard[0].img[1]}" class="d-block w-100 img-thumbnail" alt="...">
          </a>
          <a data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3">
            <img src="${productsCard[0].img[2]}" class="d-block w-100 img-thumbnail" alt="...">
          </a>
        ...
        <div id="carouselExampleIndicators" class="col-md-10 col-xs-12 col-sm-12 carousel slide" data-bs-touch="true">
          ...
          <div class="carousel-inner">
            <div class="carousel-item img-fluid active">
              <img src="${productsCard[0].img[0]}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item img-fluid">
              <img src="${productsCard[0].img[1]}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item img-fluid ">
              <img src="${productsCard[0].img[2]}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item img-fluid">
  ...
  <div class="col-sm-12 col-md-6 col-lg-3  mx-auto simulationHeight">
      <h3>${productsCard[0].name}</h3>
      <h5>Calificación: ${productsCard[0].rating}</h5>
      <p>${productsCard[0].description}</p>
      <p>Estado: ${productsCard[0].state}</p>  
    </div>
      ...
      <div class="row">
          ...
          <div class="col-12">
              <h4>Informacion del vendedor</h3>
                <p>ID del vendedor: ${productsCard[0].sellerID}</p>
